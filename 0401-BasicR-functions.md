...
- <span class="env-green">**double quotes**</span>
...
Two ways to generate a <span class="env-green">Bernoulli distribution</span> sample.
...
The <span class="env-green">main advantage of `map()`</span> is the helpers which allow you to write compact code for common special cases.
...
- `.f`         A function, formula, or vector (not necessarily atomic).
  ...
  - <span class="env-green">subset lists</span>
