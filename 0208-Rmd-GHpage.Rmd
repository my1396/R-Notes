...
```{r echo=F, fig.cap="Minimal example of a R Markdown website."}
knitr::include_graphics("images/site-page.png")
```
...
- `about.Rmd`:
  ...
  ```{r, child="_chunk-opt.Rmd", include=FALSE}`r ''`
...
```{r echo=FALSE, fig.cap="Build an entire website in RStudio."}
knitr::include_graphics("images/site-build.png")
```
...
- Using the `Knit` button just as you do with conventional standalone R Markdown documents.
    ...
    ```{r echo=F, fig.cap="Knit a single page of a website."}
    knitr::include_graphics("images/site-page.png")
    ```
