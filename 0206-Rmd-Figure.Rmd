...
~~~~markdown
```{r car-plot, eval=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Caption here." }`r ''`
...
~~~~markdown
```{r car-plot2, fig.width=6, fig.asp=0.6, out.width="100%", fig.cap="Caption here." }`r ''`
library(AER)
data(CASchools)
library(ggplot2)
...
```{r histogram, fig.width=6, fig.asp=0.6, out.width="100%", echo=FALSE, fig.cap="Historgram of Expenditure per Student. Fixed `fig.width` and `fig.asp`."}
...
```{r fig.width=5, fig.asp=0.6, echo=FALSE, fig.cap="Set `fig.retina=3`."}
plot(aapl$AAPL.Close)
```
