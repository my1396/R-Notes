...
\item
  ...
  To use the console by default for all your R Markdown documentsm: Tools -\textgreater{} Options -\textgreater{} R Markdown -\textgreater{} Show output inline for all R Markdown documents.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(f\_name) }
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Note that \texttt{*}'s do not show properly in html output (Fig. \ref{fig:stargazer1}, need to specify in the footnote (\texttt{notes}) manually.
\end{itemize}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{https://drive.google.com/thumbnail?id=1UWaYK2Q00xobvHsadz-EsEw0pUnhqVTs&sz=w1000}}
\caption{\label{fig:stargazer1}Failed to show significance codes.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{https://drive.google.com/thumbnail?id=1a_HaaOgYidFhQavHA2iuZgUbj5iYdbEW&sz=w1000}}
\caption{\label{fig:stargazer2}Correct significance codes.}
\end{figure}
