...
\texttt{.Renviron} is a user-controllable file that can be used to create {environment variables}. This is especially useful to avoid including credentials like API keys inside R scripts. This file is written in a key-value format, so environment variables are created in the format:
...
\AnnotationTok{date:}\CommentTok{ "2025{-}04{-}25"}
\AnnotationTok{output:}
