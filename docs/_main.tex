...
\AnnotationTok{date:}\CommentTok{ "2025{-}04{-}15"}
\AnnotationTok{output:}
...
\NormalTok{    bookdown}\SpecialCharTok{::}\FunctionTok{pdf\_document2}\NormalTok{(}
        \AttributeTok{latex\_engine =} \StringTok{"lualatex"}\NormalTok{,}
        \AttributeTok{keep\_tex =} \ConstantTok{TRUE}\NormalTok{), }
    \AttributeTok{output\_options =} \FunctionTok{list}\NormalTok{(}\FunctionTok{includes}\NormalTok{(}\AttributeTok{in\_header =} \StringTok{"preamble.tex"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
