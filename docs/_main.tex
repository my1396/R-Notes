...
\tightlist
\item
  \texttt{mtry}: Number of variables to possibly split at in each node in one tree. In plain language, it indicates how many predictor variables should be used in each tree.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(ranger) }\CommentTok{\#Best random forest implementation in R}
...
Source: \url{https://stats.stackexchange.com/a/287849}
