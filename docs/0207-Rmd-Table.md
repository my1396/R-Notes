...
<span class="env-green">**Table formatting options:**</span>

- `type = "latex" | "html" | "text"` specify output table format.

- `digits = 3` an integer that indicates how many decimal places should be used. A value of `NULL` indicates that no rounding should be done at all, and that all available decimal places should be reported. Defaults to 3 digits.
