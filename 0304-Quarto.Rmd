...
- An alternative way is to use `\eqref{eq-cross_sectional_hetero}` from `amsmath` package, which gives `(1)` with parentheses automatically. You need to prefix with Eq. [↩︎](https://github.com/quarto-dev/quarto-cli/issues/2439#issuecomment-1246720040)
