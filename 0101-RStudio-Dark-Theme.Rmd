...
A: Follow the instructions [here][license].


[license]: https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/adding-a-license-to-a-repository "GitHub: add license to your rep"
...
If you want to saves <span style='color:#00CC66'>all objects</span> in your work space, use `save.image()`.  It will creates an image of your current variables and functions, and saves them to a file called `.RData`. When R next loads, objects stored in this image are by default restored.
